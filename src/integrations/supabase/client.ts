...
const DEFAULT_SUPABASE_URL = "https://squkjqvofugkanzuqtqn.supabase.co";
const DEFAULT_SUPABASE_PUBLISHABLE_KEY = "sb_publishable_rsIif73TFSCXLHwI-FSplQ_C3I6IveM";
