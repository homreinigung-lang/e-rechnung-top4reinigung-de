ALTER TABLE public.documents ADD COLUMN IF NOT EXISTS paid_at date;
...
UPDATE public.documents SET paid_at = issue_date WHERE status = 'paid' AND paid_at IS NULL;