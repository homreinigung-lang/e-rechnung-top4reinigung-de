  ...
  head: () => ({
    meta: [
      { title: "Bankverbindung – HomR" },
      {
        name: "description",
        content:
          "Bankdaten für Rechnungen hinterlegen und Bankkonto-Anbindung vorbereiten.",
      },
      { property: "og:title", content: "Bankverbindung – HomR" },
      {
        property: "og:description",
        content: "Bankdaten verwalten und Banking-Anbindung vorbereiten.",
      },
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Link2 className="size-4" /> Bankkonto-Anbindung (Banking)
          </CardTitle>
          <CardDescription>
            Vorbereitet für die Zukunft: automatischer Abgleich von
            Zahlungseingängen mit offenen Rechnungen.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
            <li>Kontoumsätze automatisch abrufen (PSD2 / FinTS)</li>
            <li>Zahlungseingänge automatisch Rechnungen zuordnen</li>
            <li>Offene Posten und Mahnwesen automatisch aktualisieren</li>
          </ul>
