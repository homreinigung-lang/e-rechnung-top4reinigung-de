...
export const Route = createFileRoute("/rechtliches/datenschutz")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:url",
        content: "https://e-rechnung.top4reinigung.de/rechtliches/datenschutz",
      },
    ],
    links: [
      { rel: "canonical", href: "https://e-rechnung.top4reinigung.de/rechtliches/datenschutz" },
    ],
  }),
  ...
  return (
    <article className="space-y-6">
      ...
      <p className="text-sm text-muted-foreground">
        Diese Seite wird vom Betreiber der Anwendung gepflegt und informiert über die Verarbeitung
        personenbezogener Daten gemäß Art. 13 DSGVO. Stand: 01.08.2026
      </p>
      ...
      <section className="space-y-2">
        ...
        <ul className="list-disc space-y-1 pl-5 text-sm text-muted-foreground">
          <li>
            Kontodaten der Nutzer (E-Mail-Adresse, Anmeldeinformationen, ggf. Google-Konto-Kennung)
          </li>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Die Verarbeitung erfolgt zur Vertragserfüllung und Rechnungsstellung (Art. 6 Abs. 1 lit. b
          DSGVO), zur Erfüllung gesetzlicher Aufbewahrungs- und Buchführungspflichten (Art. 6 Abs. 1
          lit. c DSGVO i. V. m. § 147 AO, § 14b UStG, GoBD) sowie auf Grundlage berechtigter
          Interessen am sicheren Betrieb der Anwendung (Art. 6 Abs. 1 lit. f DSGVO).
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Rechnungen und buchhaltungsrelevante Unterlagen werden gemäß gesetzlicher
          Aufbewahrungsfristen (in der Regel 10 Jahre) unveränderbar archiviert. Übrige Daten werden
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Die Anwendung verwendet ausschließlich technisch notwendige Speichermechanismen (z. B.
          Sitzungs-Token für die Anmeldung). Es findet kein Marketing-Tracking und keine
          Profilbildung statt.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Die Übertragung erfolgt verschlüsselt über HTTPS. Der Zugriff auf Daten ist durch
          Anmeldung und zeilenbasierte Zugriffsregeln (Row Level Security) auf das jeweilige Konto
          beschränkt.
        </p>
      </section>
      ...
      <section className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          sowie das Recht auf Beschwerde bei einer Aufsichtsbehörde – für das Saarland: Unabhängiges
          Datenschutzzentrum Saarland, Saarbrücken.
        </p>
      </section>
      ...
      <p className="text-xs text-muted-foreground">
        Hinweis: Diese Datenschutzerklärung ist eine anpassbare Vorlage und ersetzt keine
